var Beet = (function () {
	...
	*/
	...
	const host = 'http://127.0.0.1:60555';
	...
	class BeetClient {
	    ...
	    static async link(){
	        return Promise.race([
	            ...
	            new Promise(async (resolve, reject) => {
	                ...
	                socket$2.on('event', event => {
	                    console.log('event', event);
	                });

	                socket$2.on('api', result => {                    
	                ...
	                socket$2.on('connect_error', async () => {
	                    allowReconnects = false;
	                    resolve(false);
	                });

	                socket$2.on('rejected', async reason => {
	    ...
	    static async sendApiRequest(request){
	        return new Promise(async (resolve, reject) => {
	            ...
	            socket$2.emit('api', {data:request, plugin});
	        });
	    }
